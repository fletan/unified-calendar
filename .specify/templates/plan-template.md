...
- **End-to-End Test**: Plan identifies at least one end-to-end test scenario covering
  frontend, backend, and database. Tests are scoped to confirm system integration across
  all main components, not to duplicate unit or integration test coverage.
